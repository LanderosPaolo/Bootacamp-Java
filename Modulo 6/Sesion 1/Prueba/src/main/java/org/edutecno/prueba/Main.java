...
import org.edutecno.prueba.controller.Profesor;
import org.edutecno.prueba.service.ICalculadora;
import org.edutecno.prueba.service.impl.CalculadoraPrin;
import org.edutecno.prueba.service.impl.CalculadoraSinAyB;
import org.edutecno.prueba.service.impl.CalculadoraSinRojos;
...
public class Main {
    public static void main(String[] args) {
        ...
        //General
        ICalculadora calculadora = new CalculadoraPrin(alumnos);
        profesor.setCalculadora(calculadora);
        System.out.println("Promedio considerando todas las notas:");
        profesor.mostrarPromedio();

        //Sin rojos
        ICalculadora calculadora2 = new CalculadoraSinRojos(alumnos);
        profesor.setCalculadora(calculadora2);
        System.out.println("Promedio sin rojos:");
        profesor.mostrarPromedio();

        //Sin alta ni baja
        ICalculadora calculadora3 = new CalculadoraSinAyB(alumnos);
        profesor.setCalculadora(calculadora3);
        System.out.println("Promedios sin notas altas ni bajas:");
        profesor.mostrarPromedio();
    }
}
